...
<body>
	...
	<div class="text-box">
		<h1>Sharath's University</h1>
	    <p>Eductaion should be the weapon to change the world. Education is for life and not for living.</p>
	    <a href="" class="hero-btn">Reach us to know more</a>
